...
def lb_upload(file_name, file_size):
    ...
    print("Exits node:", node_ips)

    num_chunks = len(node_ips)
    file_chunk_dict = {} # {ip1: chunk_file_1, ip2: chunk_file_2}
    ...
    # 儲存資訊  {ip1: chunk_file_1, ip2: chunk_file_2}
    ...
    for ip in file_chunk_dict:
        ...
        # upload the metadata {ip1: chunk_file_1, ip2: chunk_file_2}
